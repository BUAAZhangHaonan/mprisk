...
from mprisk.data.archetype_canonical_meanings import build_archetype_canonical_meanings


def main() -> int:
    repo_root = Path(__file__).resolve().parents[1]
    parser = argparse.ArgumentParser(description="Build the frozen canonical archetype dictionary.")
    ...
    print(
        json.dumps(
            {
                "status": "ok",
                "dictionary": str(result.dictionary_path),
