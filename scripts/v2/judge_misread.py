...
Usage:
  ...
  CUDA_VISIBLE_DEVICES=0 python scripts/v2/generate_misread_inputs.py \\
  ...
  python scripts/v2/judge_misread.py \\
...
from mprisk_v2.misread import judge_many  # noqa: E402
