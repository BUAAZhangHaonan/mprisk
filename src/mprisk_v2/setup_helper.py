...
def setup_v2_cache_manifests(
    *,
    ...
    unified_manifest_path = (output_root / "unified_full_cache_manifest.json").resolve()
    ...
    summary_path = write_json(
        pccond_dir / "summary.json",
        {
            ...
            "unified_full_cache_manifest": str(unified_manifest_path),
        },
    )
    return {
